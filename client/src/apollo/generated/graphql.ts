...
export type GetCompanyQuery = { company?: { id: string, name: string, country: string, dateCreated: string, description?: string | null, employees: number, jobs: { totalCount: number, items: Array<{ id: string, title: string, dateCreated: string, description?: string | null, type: JobType, responses: number, country: string, requirements?: { englishLevel: string, years: number } | null, company: { name: string } }> } } | null };
...
export type GetJobsQuery = { jobs: { totalCount: number, items: Array<{ title: string, id: string, country: string, responses: number, type: JobType, description?: string | null, dateCreated: string, requirements?: { years: number, englishLevel: string } | null, company: { name: string } }> } };
...
export type GetJobQuery = { job?: { id: string, title: string, dateCreated: string, description?: string | null, type: JobType, responses: number, country: string, requirements?: { englishLevel: string, years: number } | null, company: { name: string } } | null };
